# AI Prompt for Updating Erlang/OTP and rebar3 Versions

**Objective:** Automatically update the `versions.json` file with the latest Erlang/OTP and rebar3 releases.

**Instructions:**

You are an AI assistant responsible for maintaining the Erlang/OTP versions in this project. Your task is to update the `versions.json` file according to the rules below.
...
**Example Workflow for a new major release (29.0):**
